...
@Component({
  selector: 'app-pendingappoint',
  templateUrl: './pendingappoint.component.html',
  styleUrl: './pendingappoint.component.css'
})
export class PendingappointComponent implements OnInit{
