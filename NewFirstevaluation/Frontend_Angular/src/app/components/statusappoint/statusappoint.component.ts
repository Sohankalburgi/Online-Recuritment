...
import { StatusappointService } from './services/statusappoint.service';

@Component({
  selector: 'app-statusappoint',
  templateUrl: './statusappoint.component.html',
  styleUrl: './statusappoint.component.css'
})
export class StatusappointComponent implements OnInit {
...
selectedStudent : any =null;
  ...
  fetchappointments(): void {
    this.appointservice.getallapplication(this.roleIdString).subscribe(data => {
      this.appoints = data;
